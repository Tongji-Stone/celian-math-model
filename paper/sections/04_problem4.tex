...
\begin{todobox}
本节为建模框架。优化应优先在问题一统一后的 7 种实验策略内比较；若连续优化，参数须限制在实验数据合理邻域并说明依据\cite{attia2020closedloop,plett2022bms3,frazier2018bo,deb2001moea}。
\end{todobox}
...
给出推荐 \((C_1^\ast,Q_1^\ast,C_2^\ast)\)，并与问题一的典型长寿命策略（如 \texttt{5C\_67PER\_4C}、\texttt{5\_3C\_54PER\_4C}）及短寿命策略 \texttt{3\_7C\_31PER\_5\_9C} 对比充电时间与寿命代理。说明适用范围（LFP、两阶段快充、早期循环窗口）与不可外推情形。
