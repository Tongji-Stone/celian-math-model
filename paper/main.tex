...
\begin{itemize}
  ...
  \item 典型长寿命策略满足 \(C_1>C_2\)（如 \(5\mathrm{C}(67\%)-4\mathrm{C}\) 等），充电时间约 10.04\,min；典型短寿命为 \(3.7\mathrm{C}(31\%)-5.9\mathrm{C}\)（\(C_1<C_2\)）。
  \item 相近充电时间下，高 SOC 区间高倍率会明显加快衰减；提高电流时降低 \(Q_1\) 有助于保持 SOH。
  \item \(3.6\mathrm{C}\) 与 \(4.8\mathrm{C}\) 合并组离散大，不宜当作典型代表。
\end{itemize}
\end{resultbox}
